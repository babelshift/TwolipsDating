...
namespace TwolipsDating.Business
{
    public interface IProfileService : IBaseService
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyCollection<TwolipsDating.ViewModels.MessageFeedViewModel>> GetMessagesReceivedByUserFeedAsync(string userId);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyCollection<TwolipsDating.ViewModels.PersonYouMightAlsoLikeViewModel>> GetRandomProfilesForDashboardAsync(string currentUserId, int numberOfProfilesToRetrieve);
