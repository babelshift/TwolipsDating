    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TwolipsDating.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TwolipsDating.Models.ApplicationDbContext context)
        {
            ...
            context.QuizTypes.AddOrUpdate(m => m.Id,
                new QuizType() { Id = 1, Name = "Individual" },
                new QuizType() { Id = 2, Name = "Minefield" });

            context.Quizzes.AddOrUpdate(m => m.Id,
                new Quiz() { Id = 1, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Technical, Name = "Technical Guru", Description = "If you can finish this, you're probably good with gadgets.", DateCreated = new DateTime(2015, 8, 1), Points = 20, IsActive = true, ImageFileName = "TechnicalGuru.jpg" },
                new Quiz() { Id = 2, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "Gamer God", Description = "Pull out your Playstation and gear up to claim victory.", DateCreated = new DateTime(2015, 8, 1), Points = 20, IsActive = true, ImageFileName = "GamerGod.jpg" },
                new Quiz() { Id = 3, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Creative, Name = "Creative Genius", Description = "Try to study up on your color theory and sewing terminology.", DateCreated = new DateTime(2015, 8, 1), Points = 20, IsActive = true, ImageFileName = "CreativeGenius.jpg" },
                new Quiz() { Id = 4, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Business, Name = "Business Sense", Description = "The former CEO of Enron would probably fail this one.", DateCreated = new DateTime(2015, 8, 1), Points = 15, IsActive = true, ImageFileName = "BusinessSense.jpg" },
                new Quiz() { Id = 5, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "Language Linguist", Description = "If you're interested in the science of language, then this is the quiz for you.", DateCreated = new DateTime(2015, 8, 1), Points = 20, IsActive = true, ImageFileName = "LanguageLinguist.jpg" },
                new Quiz() { Id = 6, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "World of Warcraft (Scout)", Description = "This entry level quiz will require you to know the basics of World of Warcraft.", DateCreated = new DateTime(2015, 8, 12), Points = 10, IsActive = true, ImageFileName = "WoW.jpg" },
                new Quiz() { Id = 7, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "World of Warcraft (Champion)", Description = "This intermediate level quiz should only be completed by regulars of Azeroth.", DateCreated = new DateTime(2015, 8, 12), Points = 15, IsActive = true, ImageFileName = "WoW.jpg" },
                new Quiz() { Id = 8, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "World of Warcraft (High Warlord)", Description = "Can you master the most difficult trivia only for seasoned veterans?", DateCreated = new DateTime(2015, 8, 12), Points = 25, IsActive = true, ImageFileName = "WoW.jpg" },
                new Quiz() { Id = 9, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Movies, Name = "Movies and Monsters", Description = "Giant spiders, spooky skeletons, swarms of ants, and a whole lot of stop motion animation.", DateCreated = new DateTime(2015, 8, 14), Points = 20, IsActive = true, ImageFileName = "MonstersAndMovies.jpg" },
                new Quiz() { Id = 10, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "Legend of Zelda", Description = "The triforce can be yours with the completion of this one. OK, so the triforce isn't real, but this quiz is.", DateCreated = new DateTime(2015, 8, 17), Points = 20, IsActive = true, ImageFileName = "Zelda.jpg" },
                new Quiz() { Id = 11, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Movies, Name = "Movie Quotes", Description = "\"The force will be with you Harry.\" -Gandalf", DateCreated = new DateTime(2015, 8, 18), Points = 20, IsActive = true, ImageFileName = "MovieQuotes.jpg" },
                new Quiz() { Id = 12, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Literature, Name = "Harry Potter", Description = "Get out your wands and head to Hogwarts. There's a foul smell in the air. Only you can solve this problem.", DateCreated = new DateTime(2015, 8, 18), Points = 20, IsActive = true, ImageFileName = "HarryPotter.jpg" },
                new Quiz() { Id = 13, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Movies, Name = "Spaceballs: The Quiz", Description = "Brought to you by the makers of Spaceballs: The Blanket and Spaceballs: The Toilet Paper.", DateCreated = new DateTime(2015, 8, 19), Points = 25, IsActive = true, ImageFileName = "Spaceballs.jpg" },
                new Quiz() { Id = 14, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Food, Name = "The Great Food Truck Quiz", Description = "All you could ever want to answer about food trucks.", DateCreated = new DateTime(2015, 8, 30), Points = 20, IsActive = true, ImageFileName = "Foodtruck.jpg" },
                new Quiz() { Id = 15, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "The Walking Dead", Description = "If you can pass this quiz, you would probably survive a zombie apocalypse.", DateCreated = new DateTime(2015, 8, 30), Points = 20, IsActive = true, ImageFileName = "WalkingDead.jpg" },
                new Quiz() { Id = 16, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Movies, Name = "Star Wars Characters", Description = "There's a lot of them, but we managed to fit the important ones into this quiz.", DateCreated = new DateTime(2015, 9, 12), Points = 20, IsActive = true, ImageFileName = "StarWarsCharacters.jpg" },
                new Quiz() { Id = 17, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Movies, Name = "Movies of the 90s", Description = "The 90s had a lot of grunge rock, cable television, and the Internet. Oh, and some really good movies.", DateCreated = new DateTime(2015, 9, 12, 11, 0, 0), Points = 15, IsActive = true, ImageFileName = "Movies90s.jpg" },
                new Quiz() { Id = 18, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "Ocean Depths", Description = "It is said that more is known about the Moon than Earth's oceans. What do you know about them?", DateCreated = new DateTime(2015, 9, 13, 15, 0, 0), Points = 25, IsActive = true, ImageFileName = "OceanDepths.jpg" },
                new Quiz() { Id = 19, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Sports, Name = "Summer Olympics", Description = "Which obscure olympics sport do you prefer? Handball? Or maybe equestrian-related? Let's find out.", DateCreated = new DateTime(2015, 9, 13, 19, 0, 0), Points = 20, IsActive = true, ImageFileName = "SummerOlympics.jpg" },
                new Quiz() { Id = 20, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "Exotic Animals", Description = "Watch out for alligators and eagles. You might just be their next target.", DateCreated = new DateTime(2015, 9, 13, 22, 0, 0), Points = 20, IsActive = true, ImageFileName = "ExoticAnimals.jpg" },
                new Quiz() { Id = 21, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "Star Trek: The Original Series", Description = "Where no quiz has gone before. You don't have to be a trekkie to know these answers.", DateCreated = new DateTime(2015, 9, 19, 23, 0, 0), Points = 15, IsActive = true, ImageFileName = "StarTrekTOS.jpg" },
                new Quiz() { Id = 22, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "Futurama Characters", Description = "How much do you know about the 31st century?", DateCreated = new DateTime(2015, 9, 22, 10, 0, 0), Points = 20, IsActive = true, ImageFileName = "FuturamaCharacters.jpg" },
                new Quiz() { Id = 23, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Sports, Name = "Winter Olympics", Description = "While not as popular as the Summer Olympics, there's still a lot of fun to be had.", DateCreated = new DateTime(2015, 9, 22, 11, 0, 0), Points = 20, IsActive = true, ImageFileName = "WinterOlympics.jpg" },
                new Quiz() { Id = 24, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.History, Name = "World War II: The Pacific", Description = "The Pacific Ocean Theater of World War II saw the pinnacle and fall of the Japanese Empire.", DateCreated = new DateTime(2015, 9, 22, 12, 0, 0), Points = 20, IsActive = true, ImageFileName = "WorldWarIIPacific.jpg" },
                new Quiz() { Id = 25, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Sports, Name = "Golf Courses", Description = "Watch out for sand traps. They're dangerous.", DateCreated = new DateTime(2015, 9, 27, 12, 0, 0), Points = 15, IsActive = true, ImageFileName = "GolfCourses.jpg" },
                new Quiz() { Id = 26, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Literature, Name = "LOTR: The Fellowship of the Quiz", Description = "A wizard comes to your doorstep and asks for a favor. What do you do?", DateCreated = new DateTime(2015, 9, 27, 18, 0, 0), Points = 20, IsActive = true, ImageFileName = "LOTR1.jpg" },
                new Quiz() { Id = 27, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Literature, Name = "LOTR: The Two Quizzes", Description = "Bad orcs, good trees, bad humans, good elves. It's hard to keep track of alliances on Middle Earth.", DateCreated = new DateTime(2015, 9, 27, 19, 0, 0), Points = 15, IsActive = true, ImageFileName = "LOTR2.jpg" },
                new Quiz() { Id = 28, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Literature, Name = "LOTR: The Return of the Quiz", Description = "This quiz might allow you to reclaim the throne of Gondor without having to defeat Sauron.", DateCreated = new DateTime(2015, 9, 27, 20, 0, 0), Points = 20, IsActive = true, ImageFileName = "LOTR3.jpg" },
                new Quiz() { Id = 29, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "The Solar System", Description = "We orbit an ordinary yellow star. How much do you know about the local objects?", DateCreated = new DateTime(2015, 9, 28, 13, 0, 0), Points = 20, IsActive = true, ImageFileName = "SolarSystem.jpg" },
                new Quiz() { Id = 30, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "The Known Planets", Description = "Unfortunately, Pluto will have to sit out of this quiz. Maybe he will get his chance again some day.", DateCreated = new DateTime(2015, 9, 28, 14, 0, 0), Points = 20, IsActive = true, ImageFileName = "ThePlanets.jpg" },
                new Quiz() { Id = 31, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "The Milky Way", Description = "A broad and ample road, whose dust is gold, and pavement stars.", DateCreated = new DateTime(2015, 9, 28, 16, 0, 0), Points = 20, IsActive = true, ImageFileName = "MilkyWay.jpg" },
                new Quiz() { Id = 32, QuizTypeId = (int)QuizTypeValues.Individual, QuizCategoryId = (int)QuizCategoryValues.Business, Name = "Stock Markets", Description = "Buyers, sellers, networks, transactions, shares, and securities. Wow, the terminology can be confusing.", DateCreated = new DateTime(2015, 9, 29, 12, 0, 0), Points = 20, IsActive = true, ImageFileName = "StockMarket.jpg" },
                ...
                new Quiz() { Id = 37, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "United States' Capitals", Description = "Can you select all the capital cities of the United States?", DateCreated = new DateTime(2015, 10, 6, 19, 0, 0), Points = 20, IsActive = true, ImageFileName = "StateCapitals.jpg" },
                ...
                new Quiz() { Id = 43, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "Firefly Characters", Description = "Select all main characters from Firefly.", DateCreated = new DateTime(2015, 10, 25, 16, 0, 0), Points = 20, IsActive = true, ImageFileName = "FireflyCharacters.jpg" },
                new Quiz() { Id = 44, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Math, Name = "Common Quadrilaterals", Description = "What are the most common names of quadrilaterals?", DateCreated = new DateTime(2015, 10, 25, 18, 0, 0), Points = 20, IsActive = true, ImageFileName = "Quadrilateral.jpg" },
                new Quiz() { Id = 45, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Math, Name = "Order of Operations", Description = "What do all the letters in PEMDAS stand for?", DateCreated = new DateTime(2015, 10, 25, 19, 0, 0), Points = 20, IsActive = true, ImageFileName = "OrderOfOperations.jpg" },
                new Quiz() { Id = 46, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "NATO Members", Description = "Which of these countries are part of NATO? (not all members are included in this quiz)", DateCreated = new DateTime(2015, 10, 29, 19, 0, 0), Points = 25, IsActive = true, ImageFileName = "NATOMembers.jpg" },
                new Quiz() { Id = 47, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "European Union Members", Description = "Which of these countries are part of the European Union? (not all members are included in this quiz)", DateCreated = new DateTime(2015, 10, 29, 20, 0, 0), Points = 15, IsActive = true, ImageFileName = "EUMembers.jpg" },
                new Quiz() { Id = 48, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Sports, Name = "MLB Hall of Fame Pitchers", Description = "Can you select all of the pitchers inducted to the MLB Hall of Fame?", DateCreated = new DateTime(2015, 10, 29, 21, 0, 0), Points = 25, IsActive = true, ImageFileName = "HallOfFamePitchers.jpg" },
                new Quiz() { Id = 49, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "Largest Lakes in the World by Area", Description = "Which of these lakes is among the top ten largest lakes in the world by area?", DateCreated = new DateTime(2015, 11, 2, 19, 0, 0), Points = 20, IsActive = true, ImageFileName = "LargestLakesByArea.jpg" },
                new Quiz() { Id = 50, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.History, Name = "First Ten United States Presidents", Description = "Can you select the first ten people to serve as the President of the United States?", DateCreated = new DateTime(2015, 11, 2, 20, 0, 0), Points = 20, IsActive = true, ImageFileName = "FirstTenUSPresidents.jpg" },
                new Quiz() { Id = 51, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "States of Matter", Description = "What are the four fundamental states of matter?", DateCreated = new DateTime(2015, 11, 3, 9, 0, 0), Points = 10, IsActive = true, ImageFileName = "StatesOfMatter.jpg" },
                new Quiz() { Id = 52, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Science, Name = "Taxonomic Ranks", Description = "What are the eight main taxonomic ranks in zoology?", DateCreated = new DateTime(2015, 11, 3, 10, 0, 0), Points = 20, IsActive = true, ImageFileName = "TaxonomicRanks.jpg" },
                new Quiz() { Id = 53, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "Final Fantasy VII Characters", Description = "Select all of the playable characters from Final Fantasy VII.", DateCreated = new DateTime(2015, 11, 3, 11, 0, 0), Points = 20, IsActive = true, ImageFileName = "FinalFantasyVIICharacters.jpg" },
                new Quiz() { Id = 54, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "Earthbound Characters", Description = "Select all of the playable characters from Earthbound.", DateCreated = new DateTime(2015, 11, 3, 12, 0, 0), Points = 20, IsActive = true, ImageFileName = "EarthboundCharacters.jpg" },
                new Quiz() { Id = 55, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "North American Mountains", Description = "Can you name the tallest 5 mountain peaks in North America?", DateCreated = new DateTime(2015, 11, 10, 8, 0, 0), Points = 25, IsActive = true, ImageFileName = "NorthAmericanMountains.jpg" },
                new Quiz() { Id = 56, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "South American Mountains", Description = "Can you name the tallest 5 mountain peaks in South America?", DateCreated = new DateTime(2015, 11, 10, 9, 0, 0), Points = 25, IsActive = true, ImageFileName = "SouthAmericanMountains.jpg" },
                new Quiz() { Id = 57, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Geography, Name = "Asian Mountains", Description = "Can you name the tallest 5 mountain peaks in Asia?", DateCreated = new DateTime(2015, 11, 10, 10, 0, 0), Points = 25, IsActive = true, ImageFileName = "AsianMountains.jpg" },
                new Quiz() { Id = 58, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.VideoGames, Name = "Games Created by Bioware", Description = "Which of these games were created by Bioware?", DateCreated = new DateTime(2015, 11, 16, 12, 0, 0), Points = 25, IsActive = true, ImageFileName = "BiowareGames.jpg" },
                new Quiz() { Id = 59, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Food, Name = "Foods to Avoid with Braces", Description = "Which of these foods should you avoid while wearing braces?", DateCreated = new DateTime(2015, 11, 16, 13, 0, 0), Points = 15, IsActive = true, ImageFileName = "FoodsBraces.jpg" },
                new Quiz() { Id = 61, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Literature, Name = "Plays by Shakespeare", Description = "Which of these titles was written by William Shakespeare?", DateCreated = new DateTime(2015, 11, 16, 14, 0, 0), Points = 20, IsActive = true, ImageFileName = "Shakespeare.jpg" });
