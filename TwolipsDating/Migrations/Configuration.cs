    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TwolipsDating.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TwolipsDating.Models.ApplicationDbContext context)
        {
            ...
            context.Quizzes.AddOrUpdate(m => m.Id,
                ...
                new Quiz() { Id = 15, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "The Walking Dead", Description = "If you can pass this quiz, you would probably survive a zombie apocolypse.", DateCreated = new DateTime(2015, 8, 30), Points = 20, IsActive = true, ImageFileName = "WalkingDead.jpg" },
