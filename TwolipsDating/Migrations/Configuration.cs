    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TwolipsDating.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TwolipsDating.Models.ApplicationDbContext context)
        {
            ...
            context.Quizzes.AddOrUpdate(m => m.Id,
                ...
                new Quiz() { Id = 35, QuizTypeId = (int)QuizTypeValues.Minefield, QuizCategoryId = (int)QuizCategoryValues.Food, Name = "Select the Fruits", Description = "Two decades between series and still just as good.", DateCreated = new DateTime(2015, 10, 3, 19, 0, 0), Points = 15, IsActive = true, ImageFileName = "SelectTheFruits.jpg" });
