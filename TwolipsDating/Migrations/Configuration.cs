    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TwolipsDating.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TwolipsDating.Models.ApplicationDbContext context)
        {
            ...
            context.Quizzes.AddOrUpdate(m => m.Id,
                ...
                new Quiz() { Id = 34, QuizCategoryId = (int)QuizCategoryValues.Television, Name = "Star Trek: The Next Generation", Description = "Two decades between series and still just as good.", DateCreated = new DateTime(2015, 10, 2, 15, 0, 0), Points = 15, IsActive = true, ImageFileName = "StarTrekTNG.jpg" });
