namespace TwolipsDating.Migrations
{
    ...
    public partial class UpdateConversationViewToIncludeUserIsActive : DbMigration
    {
        public override void Up()
        {
            ...
            this.CreateView("dbo.MessageConversations", @"
	            ...
	            senderUser.IsActive as 'IsSenderActive',
	            ...
	            receiverUser.IsActive as 'IsReceiverActive',
            ...
            from 
	            ...
	            left join dbo.UserImages senderProfileImage on senderProfileImage.Id = senderProfile.UserImageId
	            left join dbo.UserImages receiverProfileImage on receiverProfileImage.Id = receiverProfile.UserImageId ; 
            ");
