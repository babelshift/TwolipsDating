...
exec dbo.InsertQuizQuestion 'What is the scientific study of language?', 2, 5, @answers;
...
exec dbo.InsertQuizQuestion 'How many languages are estimated to exist in the world?', 4, 5, @answers;
...
exec dbo.InsertQuizQuestion 'Braille is a form of encoding language into what?', 2, 5, @answers;
...
exec dbo.InsertQuizQuestion 'Which organ coordinates all linguistic activity?', 3, 5, @answers;
...
exec dbo.InsertQuizQuestion 'English is part of what language family?', 3, 5, @answers;
...
exec dbo.InsertQuizQuestion 'At what stage of human development is language most easily learned?', 2, 5, @answers;
...
exec dbo.InsertQuizQuestion 'What is one way in which human language is unique compared to other animals?', 2, 5, @answers;
...
exec dbo.InsertQuizQuestion 'Which speech disorder is recognized by repetitions of sounds?', 2, 5, @answers;
...
exec dbo.InsertQuizQuestion 'Who discovered the speech center of the human brain?', 5, 5, @answers;
...
exec dbo.InsertQuizQuestion 'Which book involves using tight control over language to control how people think?', 2, 5, @answers;