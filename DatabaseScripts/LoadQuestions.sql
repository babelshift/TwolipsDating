...
insert into @answers(Content, IsCorrect) values('Uses the Elder Wand',0);
...
exec dbo.InsertQuestion 'How does Harry fix his wand in the seventh Harry Potter book?',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('Aurora',0);
insert into @answers(Content, IsCorrect) values('Jasmine',0);
insert into @answers(Content, IsCorrect) values('Snow White',0);
insert into @answers(Content, IsCorrect) values('Cinderella',0);
exec dbo.InsertQuestion 'Who is the youngest Disney princess?',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('Eric',0);
...
exec dbo.InsertQuestion 'What is the name of the princess in The Little Mermaid?',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('Eugene Fitzherbert',0);
...
exec dbo.InsertQuestion 'What is Flynn Rider''s real name?',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('TRUE',0);
insert into @answers(Content, IsCorrect) values('FALSE',0);
insert into @answers(Content, IsCorrect) values('',0);
insert into @answers(Content, IsCorrect) values('',0);
exec dbo.InsertQuestion 'Elsa and Anna are not official Disney princesses. True or false?',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('Riku',0);
insert into @answers(Content, IsCorrect) values('Sora',0);
insert into @answers(Content, IsCorrect) values('Kairi',0);
insert into @answers(Content, IsCorrect) values('Mickey Mouse',0);
exec dbo.InsertQuestion 'Who is the main protagonist in Kingdom Hearts.',5,1, @answers;
delete from @answers;
insert into @answers(Content, IsCorrect) values('Noriko Matsueda',0);
insert into @answers(Content, IsCorrect) values('Nobuo Uematsu',0);
...
exec dbo.InsertQuestion 'Who composed Final Fantasy VII''s music?',5,1, @answers;
delete from @answers;
...
insert into @answers(Content, IsCorrect) values('Lightning',0);
exec dbo.InsertQuestion 'Who is the main protagonist in Final Fantasy XIII?',5,1, @answers;