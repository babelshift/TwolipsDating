...
exec dbo.InsertQuizQuestion 'In traditional color theory, what are the three primary colors?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'A tutu is tradtionally worn during which type of dance performance?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'Michelangelo''s David belongs to which branch of visual arts?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'In what country was Rembrandt van Rijn born?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'Oscar-Claude Monet was a founder of which movement?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'What are the names of the two clefs in modern music staff notation?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'Which of the following is not recognized as a common family of instruments?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'A body of singers who perform together as a group is called what?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'What is a popular layer of protection as well as decoration given to ceramic bodies?', 0, 3, @answers;
...
exec dbo.InsertQuizQuestion 'The earliest known ceramic objects were discovered in what modern day country?', 0, 3, @answers;