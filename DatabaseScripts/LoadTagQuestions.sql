...
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'A formation of stars in the observable sky from Earth are often called what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 2, Id from dbo.Questions where Content = 'Star Trek: The Original Series was cancelled so this show could stay on the air?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'When boiling water what does adding salt do?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'When boiling water what does adding salt do?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What is blanching a vegetable?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'In cooking, what does the term braise mean?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What is the hottest part of a chili pepper?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What is the difference of a spice and a herb?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'In molecular gastronomy, what is the primary purpose of using liquid nitrogen?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What part of a cow does filet mignon come from?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'What part of a cow does filet mignon come from?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Wolfgang Puck is from what country?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'Wolfgang Puck is from what country?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'The resulting slices of julienning a vegetable would be about the size of what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'The resulting slices of julienning a vegetable would be about the size of what?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'In cooking, what does macerate mean?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'In cooking, what does macerate mean?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'When meat is browned in a pan, the bits of caramelized juices that remain in the pan are called what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'When meat is browned in a pan, the bits of caramelized juices that remain in the pan are called what?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'A natural red velvet has what ingrediate to make it red?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'A natural red velvet has what ingrediate to make it red?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'Where is lebkuchen a traditional Christmas cookie from?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'A traditional pesto sauce consists of basil, Parmesan, olive oil, salt and?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What is a blond roux?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'What is a blond roux?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What''s the difference between a convection oven and a conventional oven?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What degree is required to smoke meat?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'What custard dessert is likely to appear on most Latin American or Spanish menus?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'What custard dessert is likely to appear on most Latin American or Spanish menus?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'In cooking, what is a mole?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 14, Id from dbo.Questions where Content = 'How is the meat cooked in a steak tartare?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 20, Id from dbo.Questions where Content = 'How is the meat cooked in a steak tartare?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'According to Edwin Jenner, doctors in what country came close to finding a cure?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who are the leaders at Terminus?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What was Ricks job before the event?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Where does the second half of Season 5 take place?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What did Dr. Jenner tell Rick when he whispered in his ear?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'After Carl is shot, where do Otis and Shane go to get medical supplies?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'The Walking Dead TV show is based of what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'When did the Walking Dead premier?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What filmmaker was originally the writer, director and executive producer of The Walking Dead?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What filmmaker was originally the writer, director and executive producer of The Walking Dead?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What number Shane had on his chain?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Anakin Skywalker eventually became who?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Princess Leia and Luke Skywalker were what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'C3PO and R2D2 were characters based on what movie?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What is Han Solo''s Dungeons and Dragons alignment?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Who trained Obi Wan Kenobi?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What color was Mace Windu''s lightsaber?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What type of creature was Chewbacca?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Why did Darth Vader have to wear a suit?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Approximately how old is Yoda in The Empire Strikes Back?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What were Luke Skywalker''s aunt and uncle named?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Who did Vincent Vega work for in Pulp Fiction?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What was Andy Dufresne in jail for in The Shawshank Redemption?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What was the nickname of the killer in Scream?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Finish this sentence from Fight Club: His name was ___.';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Which movie from the 90s is the highest grossing film of all time?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'What was the last name of the main Agent in The Matrix?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'According to Forrest Gump''s mother, life is like what?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'In American Beauty, which flowers makes multiple symbolic appearances?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Who directed The Sixth Sense?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 16, Id from dbo.Questions where Content = 'Contact was based on a book by which author?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'What is the deepest part of the world''s oceans named?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'Which ocean contains the deepest part?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'Because most light does not reach the bottom of the ocean, there is no abundance of life there. True or false?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'How does much of the bottom dwelling life get its energy?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'What vehicle do people use to explore extremely deep parts of the ocean?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'What is it called when a creature emits its own light?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'Even at crushing pressures in the bottom of the deepest ocean trenches, starfish can still be found. True or false?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'What is the most commonly found element in the ocean?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'What is the average depth of all the world''s oceans?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 22, Id from dbo.Questions where Content = 'Which ocean is the most shallow on average?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which year did the first Summer Olympic Games start?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 33, Id from dbo.Questions where Content = 'Which year did the first Summer Olympic Games start?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'How often do the Summer Olympic Games occur?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which city held the most recent (2012) Summer Olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country will be hosting the first South American Summer Olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which two Summer Olympics were cancelled due to World War II?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 33, Id from dbo.Questions where Content = 'Which two Summer Olympics were cancelled due to World War II?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which year saw the first worldwide televised broadcast of the olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 33, Id from dbo.Questions where Content = 'Which year saw the first worldwide televised broadcast of the olympics?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which city hosted the olympics in which a terrorist organization took hostages?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 33, Id from dbo.Questions where Content = 'Which city hosted the olympics in which a terrorist organization took hostages?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'When diving was first introduced to the olympics, what was it nicknamed?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country holds the most gold medals for Judo?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country has hosted the olympics in which handball was introduced and then re-introduced?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'The emu is the second largest living bird. What''s the largest?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'All arachnids have how many legs?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Stoats were introduced to New Zealand to control which species?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Which insect was believed to have supernatural powers by some early civilizations?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'What is one of the main threats of taking an exotic animal as a pet?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Does an axolotl live on land, in the sky, or in water?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Are jackals omnivores, herbivores, or carnivores?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Genets are most commonly found on what continent?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Why do some animals go into hibernation?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 12, Id from dbo.Questions where Content = 'Which type of bird has undergone more exploitation than any other group?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who was the captain of the USS Enterprise?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who was the first officer of the USS Enterprise?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who was the chief medical officer of the USS Enterprise?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who was the chief engineer of the USS Enterprise?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'How many seasons did The Original Series have?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Why did vulcans decide to behave in extremely logical manners?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Kirk often made deals with the enemy for control of his starship. True or false?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What was the name of the creature that Kirk was forced to fight alone?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which of the following races was most continiously hostile to the Federation?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'How did crewmembers most commonly go from the starship to various planet surfaces?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What is Fry''s brother''s name?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What is Leela''s first name?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'How is Fry related to the Professor?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What planet is Amy from?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What kind of material does Nibbler create?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What is Zoidberg''s job at Planet Express?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who is Fry''s grandfather?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'When Bender doesn''t drink alcohol, what happens?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which Star Trek character was Zapp Brannigan based on?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Hermes was in the Olympics for which sport?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'What year was the first Winter Olympics held?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What year was the first Winter Olympics held?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country will host the 2018 Winter Olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which of these countries has been banned from the Winter Olympics at certain times?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which of these countries has been banned from the Winter Olympics at certain times?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Why was the 1940 Winter Olympics cancelled?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Why was the 1940 Winter Olympics cancelled?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'What is the main goal of Downhill Skiing?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'What vehicle do people ride in when competign in Luge?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country holds the most gold medals for Ski Jumping?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'What is one way to be disqualified in Speed Skating?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'Which country has hosted the most Winter Olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which country has hosted the most Winter Olympics?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 29, Id from dbo.Questions where Content = 'How many sports were included in the first Winter Olympics?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'How many sports were included in the first Winter Olympics?';
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who were two major opposing forces of the Pacific Theater? ';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What year did Japan attack Pearl Harbor?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'For what major reason did Japan begin expanding its empire in the Pacific?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which of these islands was captured during Japan''s initial attacks?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which country had Japan been at war with before the Pacific Theater officially began?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which US state other than Hawaii was also attacked by Japan?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'What was the name that Japan gave to its Pacific Empire?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which year did the Pacific Theater (and World War II) end?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Which island is featured in the famous Raising the American Flag image?';	
insert into dbo.TagQuestions(Tag_TagId, Question_Id) select 34, Id from dbo.Questions where Content = 'Who was the Emperor of Japan during World War II?';	
